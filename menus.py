...
Saboreie já o seu!''')
    ...
    seu_pedido = comanda(tama, preco, sabor_base, escolhidos, valor_escolhidos)
    global conta
    conta = seu_pedido [1] 
  

    confirmacao_pedido(seu_pedido [0], conta)
    
  elif caminho == 3:   
    Desconto = input("deseja um desconto{S/N}").upper()
    if Desconto == "S":
        print (conta[0] * 0.9)
    ...
    #while Desconto != "S" or Desconto != "N" :
